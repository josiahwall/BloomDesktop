...
export const SettingsToolControls: FunctionComponent = () => {
    ...
    useMountEffect(() => {
        getTheOneToolbox().changeToolboxSettingsState = (which, value) =>
            updateState(which, value);
        return () => {
            getTheOneToolbox().changeToolboxSettingsState = undefined;
        };
    });
    return (
        <ThemeProvider theme={toolboxTheme}>
            ...
            >
                <ToolboxCheckbox
                    ...
                    stateSetter={(value) => updateState("canvas", value)}
                ...
                <ToolboxCheckbox
                    ...
                    stateSetter={(value) =>
                        updateState("decodableReader", value)
                    }
                />
                <ToolboxCheckbox
                    ...
                    stateSetter={(value) =>
                        updateState("imageDescription", value)
                    }
                />
                <ToolboxCheckbox
                    ...
                    stateSetter={(value) =>
                        updateState("impairmentVisualizer", value)
                    }
                />
                <ToolboxCheckbox
                    tool="leveledReader"
                    ...
                    stateSetter={(value) => updateState("leveledReader", value)}
                />
                <ToolboxCheckbox
                    tool="motion"
                    ...
                    stateSetter={(value) => updateState("motion", value)}
                    requiresSubscription
                />
                <ToolboxCheckbox
                    tool="music"
                    ...
                    stateSetter={(value) => updateState("music", value)}
                    requiresSubscription
                />
                <ToolboxCheckbox
                    tool="signLanguage"
                    ...
                    stateSetter={(value) => updateState("signLanguage", value)}
                />
            </div>
        </ThemeProvider>
    );
